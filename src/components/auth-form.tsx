...
export default function AuthForm({ type }: { type: "login" | "register" }) {
  ...
  return (
    ...
    >
      <Card className="bg-secondary-background gap-0 border-2 border-border py-0 shadow-shadow">
        <CardContent className="flex flex-col gap-8 px-6 py-8">
          <form onSubmit={handleSubmit} className="flex flex-col gap-7">
            <div className="flex flex-col gap-7">
              ...
              <div className="after:border-foreground/80 relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t">
                <span className="bg-secondary-background text-muted-foreground relative z-10 px-2">
                  Or
                </span>
              </div>
              <Button
